...
function main($texto):array{
    $textoSaneado=sanearTexto($texto);
    $listaPalabras=eliminarDeterminantes(filtrarPalabras($textoSaneado));
    $palabrasContadas=contarPalabras($listaPalabras);
    $palabrasOrdenadas=ordenarPalabras($palabrasContadas);
